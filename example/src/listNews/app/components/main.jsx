...
class Main extends React.Component{
    ...
    render() {
        ...
        var listnewsInstance1 = (
            <div>
                <h3>更多在上</h3>
                <ListNews data={data1} morePosition="top" />

                <h3>更多在下</h3>
                <ListNews data={data1} morePosition="bottom" />
            </div>
        );
        ...
        var listnewsInstance2 = (
            <div>
                <ListNews data={data2} morePosition="top"/>
            </div>
        );
        ...
        var listnewsInstance3 = (
            <div>
                <ListNews data={data3} morePosition="top"/>
            </div>
        );
        ...
        var listnewsInstance4 = (
            <div>
                <h4>缩略图在左侧</h4>
                <ListNews data={data4} thumbPosition="left" />

                <h4>缩略图在右侧</h4>
                <ListNews data={data4} thumbPosition="right" />
            </div>
        )
        ...
        var listnewsInstance5 = (
            <div>
                <h4>缩略图在左下</h4>
                <ListNews data={data5} thumbPosition="bottom-left" />

                <h4>缩略图在右下</h4>
                <ListNews data={data5} thumbPosition="bottom-right" />
            </div>
        )
